...
function showIsPlaying(curZone) {
    ...
    if (state['Loop'] != curZone.settings.loop || state['Loop'] == null) {
        ...
        if (state['Loop'] == "disabled"){
            ...
            $("#buttonLoop")
            .html(getSVG('loopOne'))
            .attr("onclick", "changeZoneSetting(\'loop\', \'disabled\')")
            .removeClass()
            ...
            $("#buttonLoop")
            .html(getSVG('loop'))
            .attr("onclick", "changeZoneSetting(\'loop\', \'loop_one\')")
            .removeClass()
            .addClass("buttonSmall buttonActive")
            .css("color", "#3daee9");
        } else {
    ...
    if (state['Shuffle'] != curZone.settings.shuffle || state['Shuffle'] == null) {
        ...
        if (state['Shuffle'] == false) {
            $("#buttonShuffle")
            .html(getSVG('shuffle'))
            .attr("onclick", "changeZoneSetting(\'shuffle\', \'true\')")
            .removeClass()
            .addClass("buttonSmall buttonAvailable")
            .css("color", css['foregroundColor']);
            ...
            $("#buttonShuffle")
            .html(getSVG('shuffle'))
            .attr("onclick", "changeZoneSetting(\'shuffle\', \'false\')")
            .removeClass()
            .addClass("buttonSmall buttonActive")
            .css("color", "#3daee9");
        } else {
    ...
    if (state['Radio'] != curZone.settings.auto_radio || state['Radio'] == null) {
        ...
        if (state['Radio'] == false) {
            $("#buttonRadio")
            .html(getSVG('radio'))
            .attr("onclick", "changeZoneSetting(\'auto_radio\', \'true\')")
            .removeClass()
            .addClass("buttonSmall buttonAvailable")
            .css("color", css['foregroundColor']);
            ...
            $("#buttonRadio")
            .html(getSVG('radio'))
            .attr("onclick", "changeZoneSetting(\'auto_radio\', \'false\')")
            .removeClass()
            .addClass("buttonSmall buttonActive")
            .css("color", "#3daee9");
        } else {
